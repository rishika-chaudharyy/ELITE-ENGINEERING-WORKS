  ...
  return (
    <section className="bg-black px-6 md:px-20 py-24 relative">
      ...
      <p className="text-white/90 text-base md:text-lg text-center max-w-4xl mx-auto mb-14 leading-relaxed">
        Our Baling Press Machines are designed to compress scrap, waste, and
        recyclable materials into compact and manageable bales. These machines
        help industries reduce storage space, improve handling efficiency, and
        streamline recycling operations while maintaining safety and durability.
      </p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24">
        {[
          [
            ...
            "Compression of recyclable waste materials",
          ],
          [
            FaCompress,
            "Scrap Compression",
            "Reducing volume of metal and plastic scrap",
          ],
          [
            FaIndustry,
            "Waste Management",
            "Efficient handling of industrial waste",
          ],
          [
            FaCogs,
            "Industrial Disposal",
            "Organized disposal and storage solutions",
          ],
        ].map(([Icon, title, desc]) => (
          <div
            key={title}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
        {[
          "Significantly reduced our scrap storage area.",
          "Excellent compression performance with easy operation.",
          "Very reliable machine with strong build quality.",
        ].map((text, i) => (
          <div
            key={i}
            className="bg-[#0b0b0b] border border-white/10 p-6 rounded-xl"
