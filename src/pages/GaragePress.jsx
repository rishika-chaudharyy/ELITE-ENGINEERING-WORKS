  ...
  return (
    <section className="bg-black px-6 md:px-20 py-24 relative">
      ...
      <div className="flex justify-center mb-16">
        <img
          src={handgarage}
          alt="Hand / H-Frame Garage Press"
          className="rounded-2xl max-h-[420px] w-full max-w-4xl object-cover shadow-lg"
        />
      </div>

      {/* TITLE */}
      <h1 className="text-3xl md:text-4xl text-sky-400 font-bold text-center mb-6">
        Hand / H-Frame Garage Press
      </h1>

      {/* DESCRIPTION */}
      <p className="text-white/90 text-base md:text-lg text-center max-w-4xl mx-auto mb-14 leading-relaxed">
        Our Hand and H-Frame Garage Presses are designed for controlled
        pressing, straightening, bearing installation, and assembly operations.
        Built with heavy-duty steel frames, these presses provide excellent
        stability, operator safety, and long-lasting performance for workshops
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-20">
        {[
          ...
          "Smooth and controlled pressing",
          "Compact workshop-friendly design",
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24">
        {[
          [
            ...
            "Accurate fitting and removal of bearings",
          ],
          [FaTools, "Workshop Pressing", "General-purpose pressing operations"],
          [FaCogs, "Assembly Work", "Component fitting and alignment"],
          [FaIndustry, "Maintenance Tasks", "Repair and servicing operations"],
        ].map(([Icon, title, desc]) => (
          <div
            key={title}
            className="bg-[#0b0b0b] border border-white/10 p-6 rounded-xl
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
        {[
          "Perfect for daily workshop use with consistent performance.",
          "Very strong frame and smooth pressing action.",
