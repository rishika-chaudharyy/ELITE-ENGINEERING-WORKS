  ...
  return (
    <section className="bg-black px-6 md:px-20 py-24 relative">
      ...
      <p className="text-white/90 text-base md:text-lg text-center max-w-4xl mx-auto mb-14 leading-relaxed">
        Our Out Cutter Machines are designed for precise and consistent
        cut-to-length operations in metal processing industries. These machines
        ensure accurate sizing, smooth edges, and seamless integration into
        production lines, improving efficiency and reducing material wastage.
      </p>
      ...
      <h2 className="text-2xl md:text-3xl text-sky-400 font-bold text-center mb-12">
        Applications of Out Cutter Machine
      </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24">
        {[
          [
            FaRulerHorizontal,
            "Cut-to-Length Jobs",
            "Precise cutting to required lengths",
          ],
          [
            FaIndustry,
            "Metal Processing Units",
            "Used in sheet and bar processing industries",
          ],
          [
            FaCogs,
            "Automated Production Lines",
            "Integrated into continuous manufacturing lines",
          ],
          [FaTools, "Fabrication Plants", "General-purpose cutting operations"],
        ].map(([Icon, title, desc]) => (
          <div
            key={title}
            className="bg-[#0b0b0b] border border-white/10 p-6 rounded-xl
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
        {[
          "Very accurate length cutting every single time.",
          "Significantly improved productivity on our production floor.",
          "Smooth operation with minimal supervision required.",
        ].map((text, i) => (
          <div
            key={i}
            className="bg-[#0b0b0b] border border-white/10 p-6 rounded-xl"
