  ...
  return (
    <section className="bg-black px-6 md:px-20 py-24 relative">
      ...
      <p className="text-white/90 text-base md:text-lg text-center max-w-4xl mx-auto mb-14 leading-relaxed">
        Our Shearing Machines are designed to deliver clean, accurate, and
        consistent cutting of metal sheets and plates. Built for demanding
        industrial environments, these machines ensure high productivity,
        minimal material wastage, operator safety, and long operational life.
      </p>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mb-20">
        {[
          ...
          "Rigid and vibration-free structure",
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24 text-center">
        {[
          ["400+", "Machines Installed"],
          ["12+", "Years of Experience"],
          ["250+", "Fabrication Units"],
          ["High", "Cut Accuracy"],
        ].map(([v, l]) => (
          <div
            key={l}
      ...
      <h2 className="text-2xl md:text-3xl text-sky-400 font-bold text-center mb-12">
        Applications of Shearing Machine
      </h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-24">
        {[
          [
            FaCut,
            "Sheet Metal Cutting",
            "Accurate cutting of metal sheets and plates",
          ],
          [
            FaIndustry,
            "Fabrication Units",
            "Used in industrial fabrication workshops",
          ],
          [
            FaCogs,
            "Production Lines",
            "Continuous cutting for manufacturing lines",
          ],
          [
            FaTools,
            "Industrial Workshops",
            "General-purpose industrial cutting tasks",
          ],
        ].map(([Icon, title, desc]) => (
          <div
            key={title}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-24">
        {[
          "Provides very clean cuts with minimal material wastage.",
          "Extremely stable and reliable for daily industrial use.",
          "Excellent cutting accuracy even for thick metal sheets.",
        ].map((text, i) => (
          <div
            key={i}
            className="bg-[#0b0b0b] border border-white/10 p-6 rounded-xl"
